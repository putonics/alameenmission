      ...
      {exams.list.length > 0 && exam.docref.id ? (
        <>
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="demo-simple-select-label-examName">
              Exam Name
            </InputLabel>
            <Select
              ...
              onChange={(e) => {
                setExam(
                  Exam.parse(
                    exams.list.find((e) => e.docref.id === e.target.value)
                  ).json()
                )
              }}
            >
              {exams.list.map((e) => (
                <MenuItem key={e.docref.id} value={e.docref.id}>
                  {e.name}
                </MenuItem>
              ))}
            </Select>
          ...
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="demo-simple-select-label-subjectGroup">
              Subject group
            </InputLabel>
            <Select
              ...
              onChange={(e) => {
                ...
                newExam.subjectGroup = SubjectGroup.parse(
                  exams.list
                    .find((e) => e.docref.id === exam.docref.id)
              ...
              onChange={(e) => {
                ...
                newExam.subjectGroup.subject = Subject.parse(
                  exams.list
                    .find((e) => e.docref.id === exam.docref.id)
                    .subjectGroups.find(
                      (s) => s.name === exam.subjectGroup.name
                    )
          ...
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="demo-simple-select-label-examType">
              Exam type
            </InputLabel>
            <Select
              ...
              onChange={(e) => {
                const newExam = new Exam(exam)
                newExam.subjectGroup.subject.examType = exams.list
                  .find((e) => e.docref.id === exam.docref.id)
                  .subjectGroups.find((s) => s.name === exam.subjectGroup.name)
                  .subjects.find(
                    (s) => s.code === exam.subjectGroup.subject.code
                  )
          ...
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="demo-simple-select-label-code">
              Subject code
            </InputLabel>
            <Select
              readOnly
          ...
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="demo-simple-select-label-fullMarks">
              Full marks
            </InputLabel>
            <Select
              readOnly
